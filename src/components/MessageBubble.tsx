...
import { markRevealed } from "@/lib/messages";
...
export function MessageBubble({ message, mine, onOpenImage }: Props) {
  ...
  function handleMediaTap() {
    ...
    // Already revealed (or own image) -> open it fullscreen.
      ...
      >
        {message.type === "text" ? (
          ...
          <button
            ...
            className={clsx(
              "relative overflow-hidden shadow-petal",
            ...
            aria-label={
              revealed ? "Büyütmek için dokun" : "Mahcup görüntü — dokun"
            }
          >
            <Image
              src={message.content}
        ...
        >
          ...
          {mine && (
            <span
              ...
              className={clsx(
                "transition-opacity",
                message.isRead ? "opacity-100 text-peony-default" : "opacity-40 text-aphrodite-dark",
              )}
            >
